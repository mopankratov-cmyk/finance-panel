...
export async function POST(req: NextRequest) {
  ...
  const logGenSaveHistory = async (inputUrl: string | null, outputUrl: string | null, status?: string, reason?: string | null) => {
    await logGeneration({
      recipe_id: recipeId,
      ...
      otk_score: typeof b.otk === "number" ? b.otk : null,
      otk_axes: b.otk_axes ?? null,
      status: status || (typeof b.otk === "number" && b.otk < 7 ? "warning" : "generated"),
      source: b.source || "graph_run",
      reason: reason || null,
      niche,
