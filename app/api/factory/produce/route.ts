...
- "ai_generation_ref" (ОТК 3-8, скачет по товару) — ДИНАМИЧНОЕ видео из фото товара (FAL i2v). Держит товар на ПРОСТЫХ/жёстких формах (флакон, сумка — 7-8), на СЛОЖНЫХ детальных (мелкие части, игрушки) искажает (3) → ОТК фильтрует, фолбэк на карусель. У этого маршрута 3 ДВИЖКА (выбери поле "engine", проверено ОТК):
   • "seedance" (7/10) — ЛУЧШЕ ВСЕХ сохраняет ТЕКСТ/надписи/бренд на карточке и форму; движение скромное. Бери когда на фото есть важный текст/лого или нужен чистый премиум-показ.
   • "kling" (7/10) — плавный наезд камеры, держит жёсткую форму; текст подсмазывает. Бери для жёстких форм (сумка/флакон/бутылка) и эффектного hero-движения.
   • "pika" (4-6) — живое мягкое движение, руки-в-кадре; ТЕКСТ ПОРТИТ (кириллицу/лого искажает). Бери ТОЛЬКО когда на фото нет критичного текста и нужна живость.
