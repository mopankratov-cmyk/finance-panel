...
Верни СТРОГО JSON: {"route":"slideshow|ai_generation_ref|ai_generation|repurpose_cut|real_ugc","tool":"конкретный инструмент","why":"кратко","needs":"что нужно","alt_route":"запасной","cost":"low|medium|high"}. Только JSON.`;
