...
export async function GET(req: NextRequest) {
  try {
    ...
    let q = db
      .from("viral_videos")
      .select("id,url,platform,niche,caption,views,likes,followers_creator,virality_score,analyzed,hook_text,format_detected,sound_title,source_orbit_id,analyzed_full,created_at")
