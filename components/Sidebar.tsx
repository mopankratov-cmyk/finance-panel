...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/product", label: "Инфо по SKU", icon: PackageSearch },
      { href: "/unit", label: "Юнит-экономика", icon: Sigma },
      { href: "/ctrtest", label: "CTR по SKU", icon: MousePointerClick },
      { href: "/planning", label: "Планирование", icon: CalendarRange },
