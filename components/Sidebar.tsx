...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/inferno/patrick.html", label: "Контент-завод", icon: Megaphone },
      { href: "/card-editor", label: "Текст на карточку", icon: Type },
      { href: "/carousel", label: "Сборщик карусели", icon: Images },
      { href: "/video-overlay", label: "Монтаж-оверлей", icon: Clapperboard },
      { href: "/uniquizer", label: "Уникализатор", icon: Shuffle },
