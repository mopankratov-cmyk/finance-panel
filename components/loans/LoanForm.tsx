  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      ...
      <section className="space-y-3">
        ...
        {schedule.map((row, index) => <div key={row.id} className="grid gap-2 rounded-xl border p-3 sm:grid-cols-2 lg:grid-cols-[1.1fr_repeat(5,minmax(0,1fr))_44px]">
