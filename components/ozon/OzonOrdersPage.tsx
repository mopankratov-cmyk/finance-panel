...
interface OrdersData { generatedAt: string; scope: { label: string; count: number }; period: { days: number; from: string; to: string }; summary: { postings: number; units: number; amount: number; active: number; delivered: number; cancelled: number; delayed: number; awaitingShipment: number; refunds: number | null }; rows: OrderRow[]; warnings: string[] }
