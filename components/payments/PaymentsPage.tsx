...
export function PaymentsPage() {
  ...
  const handleCleanDemo = async () => {
    if (
      !confirm(
        "Удалить стартовые демо-данные: платежи на счетах «WB Счёт 1/2», «Ozon», «Банковский счёт», «Наличные», которые не пришли из файла или выписки и не привязаны к компании, и сами эти счета, если на них ничего не останется?\n\nБоевые платежи и счета с ними не тронутся. Действие необратимо.",
      )
    )
      return;
    try {
