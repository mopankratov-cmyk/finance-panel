  ...
  return (
    <div className="space-y-3">
      <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
        ...
        <p className="mt-1 text-[11px] text-slate-500">Заказано — стоимость товара по заказам этого кабинета. Оплачено — из этапов оплаты. Получено — по факту приёмки, в цене заказа. Баланс = оплачено − получено: положительный — аванс поставщику, отрицательный — долг перед вами.</p>
      </div>
