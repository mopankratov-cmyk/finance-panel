  ...
  return (
    <div className="min-h-[calc(100dvh-54px)] bg-[#f6f7f9] pb-20 md:pb-6">
      ...
      <div className="space-y-3 px-2 py-3 sm:px-6">
        ...
        {/* Пояснение шага живёт в полосе только с lg. Ниже — на всех телефонах
            и на iPad в портрете — от шага оставались номер и заголовок, а что
            на нём делают, не показывалось больше нигде. */}
        <p className="-mt-1 px-1 text-[11px] leading-4 text-slate-500 lg:hidden">{STEPS[step - 1]?.hint}</p>
