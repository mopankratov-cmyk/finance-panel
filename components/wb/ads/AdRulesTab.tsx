    ...
    <div className="space-y-3">
      ...
      */}
      <div className="rounded-xl border border-sky-200 bg-sky-50 px-4 py-3 text-[12px] leading-5 text-sky-900">
        {/*
          Время здесь обязано совпадать с расписанием крона в vercel.json:
          `0 6 * * *` по UTC — это 9:00 по Москве. Плашка говорила «10:00»,
          потому что расписание однажды сдвинули на час, а текст остался. Цена
          расхождения не в опечатке: человек, который в 9:30 не видит прогона,
          решает, что автоматика сломалась, и лезет менять ставки руками. За
          парой стоит тест `tests/advert-rules-schedule.test.mts`.
        */}
        <b>Прогон раз в сутки, 9:00 по Москве.</b> Включённое правило меняет ставку само. Кнопка «Что сделали бы правила
