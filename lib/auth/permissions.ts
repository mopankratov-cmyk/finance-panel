...
export const ROLE_PERMISSIONS: Record<Role, readonly Permission[]> = {
  ...
  // §10. Закупки, поставщики и себестоимость. Приёмка на складе — не его:
  // это единственная операция склада, которую держит роль warehouse
  // (аудит P3 нашёл расхождение между старой формулировкой ТЗ и картой прав
  // ниже — исправлена формулировка, не права; закупщик приёмку не делал и не
  // должен). Подтверждение расхождений — его (§15.4).
  buyer: [
    ...ANALYTICS,
    "cost.view", "cost.edit",
