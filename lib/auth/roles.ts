...
const ACCESS: Record<Role, string[]> = {
  director: ["*"],
  finance: ["/", "/calendar", "/payments", "/accounts", "/loans", "/opiu", "/pnl", "/summary", "/losses", "/costs", "/supplies", "/ad-docking", "/agent", "/sync", "/ozon", "/inferno", "/abc", "/trends", "/market", "/card-editor", "/carousel", "/video-overlay", "/uniquizer"],
