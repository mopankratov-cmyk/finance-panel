...
const ACCESS: Record<Role, string[]> = {
  ...
  seller: ["/wb/rnp", "/wb/planning", "/wb/funnel", "/wb/adverts", "/wb/supplies", "/wb/unit", "/wb/product", "/wb/seo", "/wb/sklejki", "/wb/reviews", "/wb/ctr", "/wb/shelf", "/wb/market", "/wb/trends", "/wb/abc", "/wb/health", "/wb/connect"],
};
