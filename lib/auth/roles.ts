...
const ACCESS: Record<Role, string[]> = {
  director: ["*"],
  finance: ["/", "/calendar", "/payments", "/accounts", "/loans", "/opiu", "/pnl", "/summary", "/losses", "/costs", "/supplies", "/repricer", "/price-solver", "/agent", "/sync", "/ozon", "/adverts", "/rnp", "/seo", "/sklejki", "/unit", "/abc", "/trends", "/market", "/card-editor", "/uniquizer"],
  manager: ["/", "/ozon", "/adverts", "/rnp", "/seo", "/sklejki", "/unit", "/costs", "/agent", "/abc", "/trends", "/market", "/card-editor", "/uniquizer"],
};
