...
// ── CLEAN: формула Lock/Change/Amount/Constraints, БЕЗ запретных формулировок, с товаром ──
{
  ...
  ok(/Lock:/.test(p) && /Change:/.test(p) && /Amount:/.test(p) && /Constraints:/.test(p), "clean: все 4 секции формулы");
