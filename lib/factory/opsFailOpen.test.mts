...
ok(/alerts\.push\(\{ level: "warn", code, detail: input\.workerDbError \|\| "снимок завода собран из резервного источника" \}\)/.test(ops), "optional worker heartbeat table is warning-only");
