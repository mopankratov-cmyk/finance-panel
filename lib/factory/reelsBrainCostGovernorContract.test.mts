...
ok(/fit_summary/.test(creativeBriefSourceBuilder) && /quality_gate/.test(creativeBriefSourceBuilder) && /exact_segment/.test(creativeBriefSourceBuilder) && /publishable_exact/.test(creativeBriefSourceBuilder) && /packGateScore/.test(creativeBriefSourceBuilder), "creative brief source marks exact-vs-transfer fit, prefers publishable exact briefs, and degrades quality gate for borrowed evidence");
