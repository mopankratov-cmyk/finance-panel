...
ok(/field_focus/.test(route) && /family_focus/.test(route) && /mediaFocusBonus/.test(route), "media backfill route accepts brief-gap focus and boosts visual/timeline evidence candidates");
