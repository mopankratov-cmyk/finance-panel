...
ok(/summary\.targetMet = summary\.completed === summary\.totalRuns && !summary\.failed && !summary\.runFail && !summary\.timeouts/.test(stress), "stress target is computed from the current stress run");
