...
ok(/"прогонов "\+String\(lsSummary\.completed\|\|0\)\+"\/"\+String\(lsSummary\.totalRuns\|\|0\)/.test(studio) && /10\/10 закрыты, стресс-цель удержана\./.test(studio) && /10\/10 ещё не закрыты, стресс-цель остаётся открытой\./.test(studio), "latest stress card stays readable and avoids extra streak badges");
