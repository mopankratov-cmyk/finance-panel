...
ok(/"предупреждения · выпуск не заблокирован"/.test(studio) && /"идёт "\+summary\.active_step/.test(studio) && /st==="done"\?"готово":st==="warning"\?"warning":"сбой"/.test(studio), "OTK panel uses operator-facing labels for warnings, step summary, and execution statuses");
