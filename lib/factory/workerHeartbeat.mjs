...
const label = toText(opts.label || process.env.WORKER_LABEL || "Пульс завода");
...
async function buildPayload() {
  ...
  return {
    worker_id: workerId,
    label,
    status: normalizeWorkerStatus(opts.status || process.env.WORKER_STATUS || active?.status || "working"),
