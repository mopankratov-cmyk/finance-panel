...
// Заказы и корзины, которые WB приписал кампании, не показывавшей этот
// артикул: человек увидел рекламу соседнего товара, а купил этот. В кабинете
// WB это отдельная строка «Конверсии из других кампаний» — вида размещения у
// таких строк нет, и в блоки они не идут, иначе портят их CPO.
export const WB_RK_BLOCK_ATTRIBUTED = "attributed";
export const WB_RK_BLOCK_ATTRIBUTED_LABEL = "Конверсии из других кампаний";
