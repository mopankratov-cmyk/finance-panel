...
/**
 * Короткие окна нужны агентским кабинетам: WB отдаёт сборочные задания всего
 * продавца, а панель показывает только товары кабинета. У агента с большим
 * оборотом задания чужих брендов съедают потолок прогона целиком, и чем короче
 * период, тем выше шанс, что в срез попадут ваши товары.
 */
export type KizReconcileDays = 1 | 3 | 7 | 30 | 60 | 90;
/**
