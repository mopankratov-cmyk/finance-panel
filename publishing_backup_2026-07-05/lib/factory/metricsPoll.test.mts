...
import { metricsPostBody, normalizeMetricsPlatform, normalizeMetricsSnapshot, summarizeMetricsPoll } from "./metricsPoll";
...
{
  equal(normalizeMetricsPlatform("Pinterest"), "pinterest", "pinterest is metrics-pollable");
  equal(normalizeMetricsPlatform("telegram"), "telegram", "telegram is metrics-pollable");
  equal(normalizeMetricsPlatform("wibes"), "wibes", "wibes is metrics-pollable");
  equal(normalizeMetricsPlatform("vk_clips"), "vk_clips", "vk clips is metrics-pollable");
}
