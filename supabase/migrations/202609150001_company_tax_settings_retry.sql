-- The original tax migration shared version 202609110001 with another file,
-- so a migration runner could record that version without applying these columns.
